...
class TestSettingsList(unittest.TestCase):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_withOverrides(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_withFile(self, mock_checkoutput, mock_exists, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.stdout')
    def test_list_withConfig(self, mock_stdout, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.stdout')
    def test_list_noConfigsFound(self, mock_stdout, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_withSection(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_format_compact(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_format_count(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_format_keys(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.git.resolve_config_option')
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_format_sections(self, mock_checkoutput, mock_resolveconfigoption, mock_validateconfig):
    ...
    @mock.patch('bin.commands.utils.execute.check_output')
    def test_list_format_pretty(self, mock_checkoutput, mock_prettyformatconfig, mock_resolveconfigoption, mock_validateconfig):

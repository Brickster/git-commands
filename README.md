...
`git-commands` has been tested using git 2.13.0 on macOS Sierra and Ubuntu Trusty Tahr. To confirm on your own system, install the test dependencies and run the test suite.
